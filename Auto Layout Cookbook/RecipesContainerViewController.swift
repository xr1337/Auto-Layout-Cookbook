...
class RecipesContainerViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        guard let identifier = CookbookStoryboardIdentifier(rawValue: segueIdentifier) else { return }
        ...
        switch identifier {
            ...
            default:
                ...
                */
                let doubleTapGesture = UITapGestureRecognizer(target: self, action: #selector(RecipesContainerViewController.handleDismissPresentedViewControllerGestureRecognizer(gestureRecognizer:)))
