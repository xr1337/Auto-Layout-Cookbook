...
class DynamicHeightLabelAndTextFieldViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        timer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(DynamicHeightLabelAndTextFieldViewController.changeFontSizeTimerDidFire(timer:)), userInfo: nil, repeats: true)
    }
