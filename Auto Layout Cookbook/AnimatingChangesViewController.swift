...
class AnimatingChangesViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        timer = Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(AnimatingChangesViewController.updateViews(timer:)), userInfo: nil, repeats: false)
    }
    ...
    @objc func updateViews(timer: Timer) {
        ...
        UIView.animate(withDuration: 0.25, animations: { [unowned self] in
            ...
            */
            ...
            self.bottomConstraint = view.safeAreaLayoutGuide.bottomAnchor.constraint(equalTo: self.topView.bottomAnchor, constant: 20.0)
            ...
            self.view.layoutIfNeeded()
                ...
                Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(AnimatingChangesViewController.updateViews(timer:)), userInfo: nil, repeats: false)
        })
    }
